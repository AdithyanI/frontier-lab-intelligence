...
test('Investment Insights expose a minimal company judgment and memo audit', () => {
  ...
  assert.match(insightSource, /Unproven/)
  assert.match(insightSource, /Watch/)
  assert.match(insightSource, /View Development in Feed ↗/)
  assert.match(insightSource, /item\.prior_assumption/)
  assert.match(insightSource, /The belief this moves/)
  ...
  assert.match(appStyles, /\.investment-agent-size-basis/)
