...
test('Insights renders canonical daily editorial judgments as a ranked, cited brief', () => {
  ...
  assert.match(insightSource, /<ul className="editorial-source-links">/)
  ...
  assert.match(appStyles, /\.editorial-entities li \{[^}]*grid-template-columns: minmax\(138px, 0\.24fr\) minmax\(104px, 0\.16fr\) minmax\(0, 1fr\);/)
