...
test('How it works describes the implemented evidence and operator boundaries', () => {
  ...
  assert.match(howItWorks, /run-day --day YYYY-MM-DD --json --no-input/)
  assert.match(howItWorks, /--launch-codex/)
  assert.match(howItWorks, /One date, one resumable run/)
  assert.match(howItWorks, /Classify the top Events/)
  assert.match(howItWorks, /Validate and import atomically/)
