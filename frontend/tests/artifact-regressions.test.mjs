...
test('Artifact content readiness is explained in expanded provenance without another column', () => {
  ...
  assert.match(artifactSource, /Not supported yet/)
  assert.match(artifactSource, /The extracted text was unusable/)
  assert.doesNotMatch(artifactSource, /error_code\.replaceAll/)
