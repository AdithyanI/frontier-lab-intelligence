...
The current published proof covers 24 Investment days from July 5–28 and ten
AI Engineering days from July 19–28, with ten routed Developments per day.
The current readers expose 240 Investment Developments (142 surfaced)
and 100 Engineering Developments (40 surfaced). The result is
...
| Feed audience routing | v15 July 5–26 production coverage complete | The current top-100 daily runs contain 2,141 completed Developments with zero unresolved failures: 774 both, 278 Engineering-only, 116 Investment-only, and 973 neither. The 22-day refresh reused all but 14 exact judgments; those incremental Luna/medium calls cost $0.083892, while the complete stored runs report $9.988445. The deterministic evidence gate handled 433 packets without a model call. The immutable v14 pass remains available as historical comparison. |
| Audience Insight generation | Investment agent v15 published for July 5–28 | The Sol/xhigh projection selects the ten highest daily ranks with a positive Investment route—not the union-positive Feed—then screens all 37 companies and retrieves only plausible complete memos. The 24 complete publications contain 240 Developments: 142 surfaced and 98 suppressed. Direction comes from the cited memo-owned bet; the daily agent decides the causal connection and whether its exact materiality threshold cleared. The current publications consumed 8,825,740 input tokens, including 3,064,839 cached tokens, and cost $51.671934. Selection skips a Development already owned by another published day and pulls the next eligible routed candidate, preserving one canonical dated Insight without shrinking the daily cohort. Complete multi-day cohorts publish in one atomic transaction and only the current prompt version can satisfy or render a publication. Qualitative calibration across marginal company connections remains the main unproven boundary. |
| AI Engineering Insight generation | Engineering agent v2 published for July 19–28 | One Sol/high call per Development judges the ten highest Engineering-routed daily candidates against the seven assumed Aion surfaces in `docs/references/aion-surfaces.json`. The ten complete publications contain 100 generated candidates: 40 surfaced and 60 suppressed. Each surfaced result names at most two concrete surfaces and explains what engineering decision the evidence could change; suppressed results preserve a reason. The lane has its own exact traces, strict validation, atomic publication, read projection, and backend regression tests. It intentionally has no company memo loop, materiality gate, PDF, or delivery path. |
...
Investment v15 is published for July 5–28 and AI Engineering v2 for July
19–28. The next step is to audit marginal company connections, surface
