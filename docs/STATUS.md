...
to a defensible public-company transmission path. The focused 26-company
context is the cold-start input for that work; the next boundary is a
structured, validated Event-to-company judgment, not broader portfolio coverage.
