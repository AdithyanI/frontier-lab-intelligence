...
is the cold-start candidate input; the next boundary is a structured, validated
Event-to-company judgment with full context retrieved only for shortlisted
matches.
