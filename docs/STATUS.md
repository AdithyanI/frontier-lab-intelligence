...
surface, suppress, and after-memo rejection paths; it is not yet a completed
full-day replay.
...
| Feed audience routing | Luna/medium Development top-100 validated for July 19–21 | The complete historical July 5–21 `daily-rank-v2` Event runs remain auditable. The self-contained `audience-routing-v13` prompt now routes one whole Development packet with all original posts and artifact lineage while leaving pure amplifiers out of semantic evidence. The July 19–20 refresh completed all 191 routable Developments with zero failures: 62 both, 26 Engineering-only, 12 Investment-only, and 91 neither, for $0.856692. The earlier July 21 run completed all 97 routable Developments with zero failures. A positive route is a recall-oriented candidate for downstream investigation, not a publishable Insight; the ten highest-ranked Developments on all three days have now completed successor Investment analysis. |
| Audience Insight generation | Company-aware Investment top-ten comparison for July 19–21 | Historical Investment v10 and AI Engineering v7 outputs remain preserved, and current readers reject their superseded Event-rank lineage as successor output. The current Sol/xhigh read projection screens all 37 companies for each of 30 Developments, surfaces 15, suppresses 15, retains 41 company assessments, and records three after-memo rejections. July 19 surfaces 3/10; July 20 and July 21 each surface 6/10. Prompt v8 makes the summary lead with what changed and omit a redundant date unless chronology needs it; July 19–20 and July 21 rank one use v8, while the remaining July 21 calibration rows retain v7. `fli insights run-investment-agent` now owns the cache-first warm request, bounded parallel fan-out, complete request/response traces, and automatic import. The July 19–20 production run completed all 20 targets, reused 272,384 cached input tokens, and reported $3.693917. The decisions and plain-language output are persisted under `investment-agent-read-v4`, whose provenance keeps the exact Feed Development, original post, and source artifacts distinct. Full-day Investment replay and an AI Engineering successor remain unproven. |
