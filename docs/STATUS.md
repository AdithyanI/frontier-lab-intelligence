...
The current published proof covers 22 Investment days from July 5–26 and eight
AI Engineering days from July 19–26, with ten routed Developments per day.
After canonical cross-day ownership, the current readers expose 217 unique
Investment Developments (140 surfaced) and 79 unique Engineering Developments
(30 surfaced). The result is intentionally conservative: launches, pilots, provider
...
| Feed audience routing | v15 July 5–26 production coverage complete | The current top-100 daily runs contain 2,142 completed Developments with zero unresolved failures: 784 both, 276 Engineering-only, 115 Investment-only, and 967 neither. The calibrated July 5–21 replay used the deterministic evidence gate for 325 unsupported packets and Luna/medium for the remaining 1,322; July 22–26 continued under the same v15 contract. Across all 22 days the stored runs report 827,904 cached input tokens and $10.0547 total cost. Five transient failures on July 20–21 succeeded on the exact resumable retry. The immutable v14 pass remains available as historical comparison. |
| Audience Insight generation | Investment agent v14 published for July 5–26 | The Sol/xhigh projection selects the ten highest daily ranks with a positive Investment route—not the union-positive Feed—then screens all 37 companies and retrieves only plausible complete memos. The 22 complete publications contain 220 generated candidates; canonical cross-day ownership exposes 217 unique Developments: 140 surfaced and 77 suppressed. Direction comes from the cited memo-owned bet; the daily agent decides the causal connection and whether its exact materiality threshold cleared. Complete cohorts publish atomically and only the current prompt version can satisfy or render a publication. Qualitative calibration across marginal company connections remains the main unproven boundary. |
| AI Engineering Insight generation | Engineering agent v2 published for July 19–26 | One Sol/high call per Development judges the ten highest Engineering-routed daily candidates against the seven assumed Aion surfaces in `docs/references/aion-surfaces.json`. The eight complete publications contain 80 generated candidates; canonical cross-day ownership exposes 79 unique Developments: 30 surfaced and 49 suppressed. Each surfaced result names at most two concrete surfaces and explains what engineering decision the evidence could change; suppressed results preserve a reason. The lane has its own exact traces, strict validation, atomic publication, read projection, and backend regression tests. It intentionally has no company memo loop, materiality gate, PDF, or delivery path. |
...
Investment v14 is published for July 5–26 and AI Engineering v2 for July
19–26. The next step is to audit marginal company connections, surface
