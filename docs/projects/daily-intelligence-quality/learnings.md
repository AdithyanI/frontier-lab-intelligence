...
- Did application-owned chronology remove the need for a new Insight-type
  field?
- Which tool or skill change most improved the agent's editorial judgment?
- Which preserved audit suggestions were useful, and which would only have
  added process before the submission?
