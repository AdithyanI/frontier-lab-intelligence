...
| done | **C. Layer curated lists:** smol.ai `prefPeople` and swyx AI High Signal as `account_source_facts` rows joined on handle; triangulation across sources drives candidate confidence. | AI High Signal: 609 members, 230 in Digg, 379 new versus Digg. smol.ai: 31 unique handles, 23 existing accounts, 8 new; 21 overlap AI High Signal, 17 overlap Digg, and 17 occur in all three. Both remain source evidence rather than automatic tracking decisions. |
