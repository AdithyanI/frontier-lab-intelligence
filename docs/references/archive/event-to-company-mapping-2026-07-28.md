...
Historical design/research snapshot from 28 July 2026. The current Investment
contract is in `../investment-company-mapping.md` and generator source; the
schema, promotion paths, and future-work instructions below are superseded.
